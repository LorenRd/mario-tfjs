...
const physics = {
    ...
    update(data) {
        ...
        // Aplica la gravedad a las entidades
    ...
    sceneryCollision(data, entity, scene) {
        ...
        if (entity.yPos < scene.yPos &&
            ...
            if (entity.type !== 'dead') { // Cae por debajo del suelo si mueres
