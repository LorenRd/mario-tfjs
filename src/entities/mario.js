...
export default class Mario extends Entity {
    constructor(img, xPos, yPos, width, height) {
        ...
        const self = this;
        this.jumpSound = new Audio('./audio/sounds/jump.wav');
        this.deathSound = new Audio('./audio/sounds/mario_death.wav');
        this.bumpSound = new Audio('./audio/sounds/bump.wav');
        this.powerupSound = new Audio('./audio/sounds/powerup.wav');
        this.powerdownSound = new Audio('./audio/sounds/powerdown.wav');
