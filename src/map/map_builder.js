...
export default class MapBuilder {
    ...
    constructor(level, tileset, spriteSheet) {
        ...
        this.mountainSheet.src = './sprites/mountain.png';
        this.cloudsSheet = new Image();
        this.cloudsSheet.src = './sprites/clouds.png';
        this.castleSheet = new Image();
        this.castleSheet.src = './sprites/castle.png';
        ...
        // Crea todas las entidades del mapa
    ...
    // Almacena todas las entidades del nivel en un mismo sitio
    create(data) {
    ...
    // Dibuja una entidad del mapa
    drawEntity(entity, data) {
        const ctx = data.canvas.ctx;
        const viewport = data.viewport;

        // Comprueba que está en el viewport
